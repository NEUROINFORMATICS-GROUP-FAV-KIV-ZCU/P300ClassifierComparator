...
function [results, global_results, test_out_features, test_out_targets] = runTesting( testing_dir, testing_file, models, param)
    % extract trials
    [test_out_features, test_out_targets] = create_feature_vector(testing_dir, testing_file, param, 'testing'); % testing trials
